...
GGML_API void quantize_row_tq2_m_ref(const float * GGML_RESTRICT x, block_tq2_m * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_tq2_n_ref(const float * GGML_RESTRICT x, block_tq2_n * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_tq2_m(const block_tq2_m * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_tq2_n(const block_tq2_n * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_tq2_m(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_tq2_n(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
