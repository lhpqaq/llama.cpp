...
void quantize_row_tq2_m(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
void quantize_row_tq2_n(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
