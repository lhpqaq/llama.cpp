...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ2_M] = {
        .type_name                = "tq2_m",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_tq2_m),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq2_m,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq2_m_ref,
    },
    [GGML_TYPE_TQ2_N] = {
        .type_name                = "tq2_n",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_tq2_n),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq2_n,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq2_n_ref,
    },
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TQ2_M:   result = quantize_tq2_m(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_TQ2_N:   result = quantize_tq2_n(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
