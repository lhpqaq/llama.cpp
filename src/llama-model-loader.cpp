...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_TQ2_M:    return "TQ2_M - 2.06 bpw ternary";
        case LLAMA_FTYPE_MOSTLY_TQ2_N:    return "TQ2_N - 2.06 bpw ternary";
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_TQ2_M:   ftype = LLAMA_FTYPE_MOSTLY_TQ2_M;   break;
            case GGML_TYPE_TQ2_N:   ftype = LLAMA_FTYPE_MOSTLY_TQ2_N;   break;
